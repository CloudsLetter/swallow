...
Cross-platform terminal client: **SSH / SFTP / Telnet / local shell** with server monitoring, key & certificate management, ProxyJump and port forwarding.
...
- **Four protocols, one entry** — SSH / SFTP / Telnet / local shell
