 ...
 *  密码=锁 / 密钥=钥匙 / 证书=盾牌，颜色与 authBadge 语义一致（sky/violet/blue）。 */
const map: Record<string, { Icon: typeof Lock; cls: string }> = {
  password: { Icon: Lock, cls: 'text-sky-600 dark:text-sky-400' },
  key: { Icon: KeyRound, cls: 'text-violet-600 dark:text-violet-400' },
  certificate: { Icon: ShieldCheck, cls: 'text-blue-600 dark:text-blue-400' },
