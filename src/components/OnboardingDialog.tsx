      ...
      >
        ...
        {step === 0 && (
          <div className="animate-fade-in flex flex-col items-center gap-4 py-2 text-center">
            <div className="flex size-16 items-center justify-center rounded-xl bg-primary/10 text-primary ring-1 ring-primary/20 shadow-[inset_0_1px_0_0_color-mix(in_oklab,var(--primary)_18%,transparent)]">
              <Terminal size={30} strokeWidth={1.8} />
            </div>
            <div>
              <h2 className="text-lg font-semibold tracking-tight">{t('onboarding.welcome')}</h2>
              <p className="mt-1 text-xs text-muted-foreground">{t('onboarding.welcomeDesc')}</p>
            </div>
            <ul className="w-full space-y-1.5 rounded-lg bg-muted/40 p-3 text-left text-xs text-muted-foreground">
        ...
        {/* 步骤 2：核心能力 */}
        {step === 1 && (
          <div className="animate-fade-in flex flex-col gap-3 py-1">
            <div className="text-center">
              <h2 className="text-lg font-semibold tracking-tight">{t('onboarding.features')}</h2>
            </div>
            {features.map((f) => (
              <div
                key={f.title}
        ...
        {step === 2 && (
          <div className="animate-fade-in flex flex-col items-center gap-4 py-2 text-center">
            ...
            <div>
              <h2 className="text-lg font-semibold tracking-tight">{t('onboarding.ready')}</h2>
